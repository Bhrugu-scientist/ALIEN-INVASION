...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        while True:
            ...
            ## Redrawing the screen during each pass of the loop.


    def _check_events(self):
        """Respond to key presses and mouse key events"""
    ...
    def _update_screen(self):
        """Updating images on the screen and flip the images to the new screen."""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decrements the ships_left, and updates the scoreboard.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                ## Treating the same as if the ship got hit.
                self._ship_hit()
                break
